...
> 台灣國家高考合格物理治療師，專精三鐵運動修復（鐵人三項累積性運動傷害與恢復）、紅繩懸吊（Redcord Neurac）、公路車 Bike Fitting 專項分析、顱薦椎治療與疼痛科學。現任領航物理治療所物理治療師暨行銷總監。治療哲學：痛往往是身體最後才用上的說法——先用紅繩把支撐補回去、把該鬆的筋膜鬆開，等身體覺得夠安全，力氣才願意回來。

## 簡介
${plainText(site.aboutText.join(' '))}

## 提供服務
- 三鐵運動修復（鐵人三項累積性運動傷害處理與恢復）
